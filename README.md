...
| MongoDB              | БД для хранения объектов (отели, рестораны, достопримечательности)                     | Гибкая структура данных (объекты бывают разных видов и имеют разные поля)<br>Снижение нагрузки на PostgreSQL<br>Индексация, интеграция с Elasticsearch |
