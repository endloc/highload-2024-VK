...
| **reviews_responses**   <br> MongoDB                               | Ответы представителей объектов на отзывы пользователей | -             |
| **reviews_photos**      <br> MongoDB                               | Фотографии, прикрепленные к отзывам                    | По review_id  |
| **objects**             <br> MongoDB                               | Данные об объектах                                     | -             |
| **objects_photos**      <br> MongoDB                               | Фотографии объектов                                    | По object_id  |
| **trips**               <br> MongoDB                               | Созданные пользователями маршруты (списки объектов)    | -             |
| **trips_objects**       <br> MongoDB                               | Связь между маршрутами и объектами                     | -             |
...
| **roles**               <br> Redis - малый объем                   | Роли, существующие для пользователей системы           | -             |
| **categories**          <br> Redis - малый объем                   | Категории объектов                                     | -             |
...
- Таблица **objects** 
  - `category_name` для фильтрации по категории
  - `country_name`, `locality_name` для поиска по местоположению
...
| Search         | 50               | 0,02021         | средняя           | 2   | 1       |
| Object         | 149              | 0,02437         | тяжелая           | 16  | 1,6     |
| Review         | 595              | 0,02439         | средняя           | 7   | 3,5     |
| Reccomendation | 25               | 0,00201         | средняя           | 2   | 1       |
| Trip           | 50               | 0,02021         | средняя           | 2   | 1       |
| File           | 198              | 1,62111         | средняя           | 5   | 2,5     |

Количество ядер и память взяты с небольшим запасом с расчетом на дальнейший рост.
