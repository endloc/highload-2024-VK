...
- [Проектирование высоконагруженной системы на примере сервиса для путешествий Tripadvisor](#проектирование-высоконагруженной-системы-на-примере-сервиса-для-путешествий-tripadvisor)
  ...
  - [9. Обеспечение надежности](#9-обеспечение-надежности)
      - [**1. Golang (backend)**](#1-golang-backend)
      - [**2. MongoDB**](#2-mongodb)
      ...
      - [**6. Kafka**](#6-kafka)
      - [**7. CronJob**](#7-cronjob)
      - [**8. Prometheus + Grafana + ClickHouse**](#8-prometheus--grafana--clickhouse)
      - [**9. Nginx**](#9-nginx)
      - [**10. Envoy**](#10-envoy)
...
Компоненты системы с указанием способов резервирования:
