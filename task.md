...
* Выбрать схемы балансировки для входящих и межсервисных запросов
* Продумать схему отказоустойчивости
* Рассчитать нагрузку по терминации SSL

## 5. Логическая схема БД

- Описать логическую схему данных
- Убедиться, что данных достаточно для работы API
- Указать размер данных и нагрузку на чтение/запись
